            ...
            <div>
                    <table class="fed" cellspacing="5" cellpadding="1">
                        <tr class="fed1">
                            ...
                            <th class="rid">Ques10 </th>    <th class="rid">Delete </th>
                        </tr>
<?php
        include 'connection.php';

        $sql = "select * from ipl_mens ";
...
<?php
        ...
        round(avg(ques10), 4) as ques10 from ipl_mens ";
...
<?php
        ...
        $sql = " select COUNT(*) as count from ipl_mens ";
...
?>
            ...
            <div>
                <button class="c1" style="width: 100px;" type="submit"> <a style="color: black;" href="sorting.php">
                    Sorted  </a>
                </button>
            </div>
        </form>
