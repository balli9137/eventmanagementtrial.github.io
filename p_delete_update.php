                        ...
                        <tr>
                            ...
                            <td class="c7">
                                <button type="submit" style="background-color: transparent; border: transparent;">
                                    <a style="text-decoration: none; color: black;" href="p_delete.php?id=<?php echo $res['id']; ?>">
                                        Remove
                                    </a>
                                </button>
                            </td>
                            <td class="c8" formtarget="_blank">
                                <button type="submit" style="background-color: transparent; border: transparent;">
                                    <a style="text-decoration: none; color: black;" href="p_update.php?id=<?php echo $res['id']; ?>">
                                        Update
                                    </a>
                                </button>
                            </td>
