...
$sql = " insert into cpl(event, email, ques1, ques2, ques3, ques4, ques5, ques6, ques7, ques8, ques9, ques10)
...
<html>
    ...
    <body>
        <form method="post"><center>
            ...
            <div class="register">
                ...
                <select name="event" required class="box">
                    <optgroup label="Qther Leagues">
                        <option value="CPL">Carribean Premier League</option>
                    </optgroup>
                </select><br><br>
                <a><b>Email:</b></a><br>
            ...
            <div class="q5">
                <a><b>Q.5)How much you like CPL?</b></a><br>
