...
<?php
        ...
        round(avg(ques10), 4) as ques10 from bbl_mens ";
...
<?php
        ...
        $sql = " select COUNT(*) as count from bbl_mens ";
...
?>
            ...
            <div>
                <button class="c1" style="width: 100px;" type="submit"> <a style="color: black;" href="bbm_sorting.php">
                    Sorted  </a>
                </button>
            </div>
        </form>
