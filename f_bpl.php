...
<?php
        ...
        round(avg(ques10), 4) as ques10 from bpl ";
...
?>
            ...
            <div>
                <button class="c1" style="width: 100px;" type="submit"> <a style="color: black;" href="bp_sorting.php">
                    Sorted  </a>
                </button>
            </div>
        </form>
