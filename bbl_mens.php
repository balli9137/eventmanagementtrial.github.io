...
$sql = " insert into bbl_mens(event, email, ques1, ques2, ques3, ques4, ques5, ques6, ques7, ques8, ques9, ques10)
...
<html>
    ...
    <body>
        <form method="post"><center>
            ...
            <div class="register">
                ...
                <select name="event" required class="box">
                    <optgroup label="Big Bash League">
                        <option value="BBL-Mens">BBL-Mens</option>
                    </optgroup>
                </select><br><br>
                <a><b>Email:</b></a><br>
            ...
            <div class="q5">
                <a><b>Q.5)How much you like BBL-Mens?</b></a><br>
