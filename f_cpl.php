...
<?php
        ...
        round(avg(ques10), 4) as ques10 from cpl ";
...
<?php
        ...
        $sql = " select COUNT(*) as count from cpl ";
...
?>
            ...
            <div>
                <button class="c1" style="width: 100px;" type="submit"> <a style="color: black;" href="cp_sorting.php">
                    Sorted  </a>
                </button>
            </div>
        </form>
